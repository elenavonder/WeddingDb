...
INSERT Guests (UserName, Password, FirstName, LastName, PhoneNumber, Email, IsReviewer, IsAdmin) VALUES
...
Id int NOT NULL PRIMARY KEY IDENTITY (1,1),
UsersId int NOT NULL FOREIGN KEY REFERENCES Guests(Id),
